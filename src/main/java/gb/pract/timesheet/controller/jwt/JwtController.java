...
import gb.pract.timesheet.controller.ExceptionResponse;
import gb.pract.timesheet.security.CustomUserDetailsService;
import gb.pract.timesheet.security.jwt.JwtService;
...
public class JwtController {
    ...
    //FIXME этим запросом мы получаем валидный токен пользователя, чтобы не аутентифицироваться каждый раз
